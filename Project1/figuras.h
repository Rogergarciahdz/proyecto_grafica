...
class CFiguras
{
	...
	void prisma2H (GLuint text, GLuint text2);
	void prisma2CaminosH (GLuint text, int cuantos);
	void prisma3H(GLuint text, GLuint text2, int hor, int ver);  //Funcion creacion prisma
...
void CFiguras::prisma2CaminosH (GLuint text, int cuantos)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);  //Top
			//glColor3f(0.8,0.2,0.4);
			glNormal3f( 0.0f,1.0f, 0.0f);
			glTexCoord2f(cuantos*1.0f, 0.0f); glVertex3fv(vertice[4]);
			glTexCoord2f(cuantos*1.0f, 1.0f); glVertex3fv(vertice[5]);
			glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
...
void CFiguras::prisma2H (GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma3H(GLuint text, GLuint text2, int hor, int ver)  //Funcion creacion prisma
{
	...
	*/
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, ver*1.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(hor*1.0, ver*1.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(hor*1.0, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0, 0.0f); glVertex3fv(vertice[6]);
	glEnd();
}
